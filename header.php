                ...
                <div class="container">
                    ...
                    <div class="right-line clearfix">
                        ...
                        <?php if(isset($_SESSION["user"]["idclients"])): ?>
                                ...
                                <li><a href="http://localhost/phpobjet/myshop/logout">Checkout</a></li>
                            <?php else: ?>
                      ...
                      <!-- // si pas connecté le formulaire-->
                      
                        <div id="login-box" class="login-popup">
                            <a href="#" class="close"><img src="images/delete.png" class="btn_close" title="Close Window" alt="Close" /></a>
                            <form method="post" class="signin" action="http://localhost/phpobjet/myshop/user-register">
