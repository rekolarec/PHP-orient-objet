...
<?php
				...
				<div class="row">
					<div class="col-md-6">
						<div class="single-img">
							<div class="sp-wrap" id="pictureItem">
					...
					<div class="col-md-6">
						<div class="single-desc">
						    ...
						    <div class="single-infos">
						    	<p><span>Brand:</span> <?php echo $itemHome[0]["libelle"];?> </p>
			...
			<div class="feat-items mb30">
				<div class="container">
					...
					<div class="list_carousel1 responsive">
						<ul id="foo1">
						<?php // boucle pour les affichages de produits
						$i = 1;
						foreach ($itemHome as $item): 
					?>
					<li class="class<?php echo $i ?>">
	...
	<script type="text/javascript" src="<?php echo HOST.FOLDER ?>js/jerome.js"></script>
</body>
</html>