...
--
-- Hôte : 127.0.0.1
-- Généré le :  jeu. 24 août 2017 à 11:06
...
(2, 'test2', 'test2', 'test2', 5, 1, 2.20, 1);
...
--
ALTER TABLE `clients`
  MODIFY `idclients` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
...
--
ALTER TABLE `orders`
  MODIFY `idorders` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;
--
